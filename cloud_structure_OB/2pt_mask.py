...
#median
norm_ac_me = space_ac_test2/space_ac_test1*np.count_nonzero(data_fluc)*np.sqrt(space_ac_test1*np.count_nonzero(data_fluc))
...
plt.clf()
plt.plot(np.hstack([pc_r1[radial_profile1.r<limit]]),np.hstack([radial_profile1.mean[radial_profile1.r<limit]]),label='unbiased')
plt.plot(np.hstack([pc_r2[radial_profile2.r<limit]]),np.hstack([radial_profile2.mean[radial_profile2.r<limit]]),label='biased')
plt.plot(np.hstack([pc_r3[radial_profile3.r<limit]]),np.hstack([radial_profile3.mean[radial_profile3.r<limit]]),label='median')
...
np.savetxt('./2pt/G106_2pt_dev_radial.txt', np.c_[pc_r1, radial_profile1.r,radial_profile1.mean,radial_profile1.std,radial_profile_number.sum], fmt='%.4f  %.4f %.4f %.4f %.4f ' )
